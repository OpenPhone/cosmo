...
export const EDFS_RABBITMQ_PUBLISH = 'edfs__rabbitmqPublish';
export const EDFS_RABBITMQ_SUBSCRIBE = 'edfs__rabbitmqSubscribe';
...
export const EDFS_RABBITMQ_STREAM_CONFIGURATION = 'edfs__RabbitMQStreamConfiguration';
...
export const PROVIDER_TYPE_RABBITMQ = 'rabbitmq';
