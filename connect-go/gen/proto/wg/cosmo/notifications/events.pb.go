...
const file_wg_cosmo_notifications_events_proto_rawDesc = "" +
	...
	"\bgraphIds\x18\x01 \x03(\tR\bgraphIds\"\xc4\x02\n" +
	"\tEventMeta\x12L\n" +
	"\n" +
	...
	"\x18monograph_schema_updated\x18\x03 \x01(\v2..wg.cosmo.notifications.GraphSchemaUpdatedMetaH\x00R\x16monographSchemaUpdatedB\x06\n" +
	"\x04meta*|\n" +
